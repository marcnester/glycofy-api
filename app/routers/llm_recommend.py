...
def _llm_pick_or_create(
    ...
    system_msg = (
        ...
        "75 g, fruit portions must be at least 30 g, oats at least 15 g, nut butter at least 8 g, and other "
        "non-seasoning foods must not use token portions below 5 g. Dry grains and rolled oats must be cooked or "
        "fully soaked; do not mix dry oats into yogurt and serve immediately.\n"
        ...
        "- Use athlete_feedback as a bounded preference signal: favor learned ingredients, proteins, styles, and "
        "methods; avoid negatively scored patterns. Keep roughly 20% exploration so recommendations do not become "
        "repetitive. Never override diet, allergy, nutrition, food-safety, or variety rules. When a learned preference "
        "materially influenced the choice, mention it briefly in reason. Do not infer allergies or medical conditions "
        "from feedback.\n"
...
def _batch_week_recommendations(
    ...
    *,
    ...
    system = (
        ...
        "single-person meal. Main-meal animal proteins must be at least 75 g. Fruit must be at least 30 g, oats at "
        "least 15 g, nut butter at least 8 g, and other foods at least 5 g except herbs, spices, acids, and salt. Dry "
        "grains and rolled oats must be cooked or fully soaked; never mix dry oats into yogurt and serve immediately. "
        "If a target cannot be met within those limits, add another practical food instead of "
        ...
        " Use athlete_feedback as a bounded preference signal: favor learned ingredients, proteins, styles, and "
        "methods; avoid negatively scored patterns; and respond to repeated portion, digestion, or practicality "
        "signals. Keep roughly 20% exploration and never override diet, allergy, nutrition, food-safety, or variety "
        "rules. When preference learning materially influenced a meal, say so briefly in its reason. Do not infer "
        "medical conditions."
    )
    payload = {
        "primary_diet": primary_diet,
